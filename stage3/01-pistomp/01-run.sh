...
for pkg in \
    ...
    pi-stomp pistomp-recovery rpi-preseed jackbridge ffmpeg-pistomp cabsim-lv2 veja-bass-cab-lv2 veja-1960-cab-lv2 loopjefe-lv2 pistomp-usb-automount pistomp-wifi; do
