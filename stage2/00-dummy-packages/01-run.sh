...
# Install early so later stages can assert their files exist
# (stage2/05-pistomp/01-run.sh), and jack2-pistomp's Provides satisfy
# stage2/04-python's libjack dependency.
apt-get install -y -qq jack2-pistomp lg-pistomp pistomp-audio
EOF
